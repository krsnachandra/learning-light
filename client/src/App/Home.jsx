...
<div className="col-lg-4 col-md-4 col-sm-6 col-xs-12">
  <div className="card">
    ...
    <div className="card-body">
      ...
      <div className="row">
        <div className="col-md-12">
          <Link to='/course'><button className="btn btn-primary btn-block">View free course</button></Link>
        </div>
      </div>
  </div>
</div>
...
<div className="col-lg-4 col-md-4 col-sm-6 col-xs-12">
  <div className="card">
    ...
    <div className="card-body">
      ...
      <div className="row">
        <div className="col-md-12">
          <a href="/courses/javascript-essentials-2" className="btn btn-primary btn-block">View free course</a>
        </div>
      </div>
  </div>
</div>
